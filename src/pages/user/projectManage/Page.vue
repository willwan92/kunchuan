    ...
    <div class="section list">
      <div class="tabs-wrapper">
        <el-tabs v-model="tabName" type="card" @tab-click="handleClick">
          <el-tab-pane label="单系统用户项目" name="2"> </el-tab-pane>
          <el-tab-pane label="集团用户项目" name="1"> </el-tab-pane>
        </el-tabs>
        <el-button
          class="btn"
          type="primary"
      ...
      >
        <el-form  v-loading="isUpdate" :model="form" ref="form" label-width="100px">
          ...
          <el-form-item label="IP范围" v-show="isLeaf">
            <el-input
              v-model="form.ip"
              placeholder="例如：192.168.1-255.1-255或192.168.1.1-255和192.168.1.1"
            ></el-input>
          </el-form-item>
        </el-form>
...
export default {
  ...
  computed: {
    ...
    pjOptions() {
      ...
      if (this.pjTreeData) {
        options =
          this.tabName === "1" ? this.pjTreeData[0] : this.pjTreeData[1];
      }
