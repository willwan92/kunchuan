      ...
      <div>
        ...
        >
          ...
          <el-form-item label="策略模板">
            <el-input
              v-model="addTaskForm.module"
              @focus="moduleDialog = true"
              style="width: 508px;"
            ></el-input>
          </el-form-item>
    ...
    <el-dialog title="详情" :visible.sync="assetListDialog" width="40%">
      <el-form label-position="left" label-width="80px" :model="assetListItem">
        ...
        <el-form-item label="资产类型">
          <el-select
            v-model="assetListItem.alias"
            placeholder="请选择"
            @change="getVendorList(assetListItem.alias)"
          >
            <el-option
        ...
        <el-form-item label="厂家名称">
          <el-select
            v-model="assetListItem.vendor"
            placeholder="请选择"
            @change="getProductList(assetListItem.alias, assetListItem.vendor)"
          >
            <el-option
        ...
        <el-form-item label="用户名">
          <el-input
            v-model="assetListItem.username"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="登录密码">
          <el-input
            v-model="assetListItem.password"
            type="password"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="su用户名">
          <el-input
            v-model="assetListItem.su_user"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="su密码">
          <el-input
            v-model="assetListItem.su_passwd"
            type="password"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="数据库账号">
          <el-input
            v-model="assetListItem.dbuser"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="数据库口令">
          <el-input
            v-model="assetListItem.dbpassword"
            type="password"
            autocomplete="off"
          ></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    assetItem(row) {
      ...
      let pjid = this.getPjId,
        ip = row.ip;
      this.fetchFuzz({
        url: "fuzz/view/page/VerificationTasks!showOneProList.action",
        params: { ip, pjid },
        vm: this
      }).then(res => {
    ...
    submitAssetItem() {
      ...
      this.fetchFuzz({
        url: "fuzz/view/page/device!editdevice.action",
        params: data,
        vm: this
      }).then(res => {
        if (res.state === 1) {
