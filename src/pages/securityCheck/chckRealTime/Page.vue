<template>
	<div class="page">
		<div class="section">
      <p>
        <el-button type="primary" size="medium" @click="addTaskFun">添加</el-button>
        <el-button type="primary" size="medium" @click="deleteRealTime">删除</el-button>
      </p>
        ...
        <el-table-column fixed="right" label="操作" width="100">
          <template slot-scope="scope">
            <p v-if="scope.row.level === 1">
              <i class="el-icon-video-play icon" v-if="scope.row.progress >= 100" @click="handleClick(scope.row, 'play')" style="color: #009688;"></i>
              <i class="el-icon-video-pause icon" v-else @click="handleClick(scope.row, 'stop')" style="color: red;"></i>
            </p>
            <P v-else>
              <i class="el-icon-document icon" style="color: #009688;" @click="openDownload(scope.row)"></i>
            </P>
          </template>
        </el-table-column>
      </el-table>
